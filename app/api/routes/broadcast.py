...
async def send_message_handler(message: Message, parse_mode: ParseMode = ParseMode.HTML,
                               chat_id: int = Query(default=settings.CHAT_ID, alias="id"), bot: Bot = Depends(BotStub)):
