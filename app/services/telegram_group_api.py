...
class TelegramGroupAPI(BaseAPI):
    ...
    async def create(self, group_id: UUID, create_telegram_group: CreateTelegramGroup) -> TelegramGroup:
    ...
    async def update(self, group_id: UUID, telegram_id: int, update_telegram_group: UpdateTelegramGroup) -> TelegramGroup:
    ...
    async def delete(self, group_id: UUID, telegram_id: int) -> None:
